...
public class Main {
    public static void main(String[] args)  {
        ...
        Car car1 = new Car("Lada", "Granta", 1.7, 20, 250, 40);
        Car car2 = new Car ("Audi", "A8 50 L TDI quattro", 3.0, 20, 200, 50);
        Car car3 = new Car("BMW", "Z8", 3.0,20, 200, 28);
        Car car4 = new Car("Kia", "Sportage", 2.4, 20, 260, 40);

        Bus bus1 = new Bus ("Mercedes", "Citaro", 11.98, 23, 200, 45);
        Bus bus2 = new Bus ("Mercedes", "Conecto", 11.97, 25, 220, 50);
        Bus bus3 = new Bus ("Mercedes", "Travego", 11.97, 23, 230, 48);
        Bus bus4 = new Bus ("Mercedes", "Tourismo", 10.68, 26, 235, 50);

        Truck truck1 = new Truck("Mercedes", "Actros", 15.6, 21, 250, 30);
        Truck truck2 = new Truck("Mercedes", "Arocs", 7.7, 24, 205, 40);
        Truck truck3 = new Truck("Mercedes", "Actros", 15.6, 26, 222, 45);
        Truck truck4 = new Truck("Mercedes", "Atego", 5.1, 20, 220, 50);
